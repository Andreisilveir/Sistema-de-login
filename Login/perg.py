...
class BrainBuster:
    def __init__(self): 
        ...
        b_s = tk.Button(self.janela, text='Sair', height=2, width=17, border=3, borderwidth=3, command=self.sair(self.janela))
    ...
    def quiz(self):
        ...
        b_r = tk.Button(self.janela1, text='Retornar', height=2, width=17, border=3, borderwidth=3, command= self.retornar(self.janela1))
        b_r.place(rely=0.94, relx=0.02)
    
        b_s = tk.Button(self.janela1, text='Sair', height=2, width=17, border=3, borderwidth=3,command= self.sair(self.janela1))
        b_s.place(rely=0.94, relx=0.9)
